    ...
    packQueryData: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            tag += '<tr class="text-c">' +
                ...
                '<td class="td-manage">' +
                '<a href="javascript:;" onclick=panel.lunbotu_edit("预览","lunbotu-check2.html?configId='+data[i].id +'","1","1000","700") class="label-success  radius label">预览</a>'+
                '</td>' +
                ...
                '<td class="td-manage">' +
                '<a href="javascript:;" onclick=panel.housing_edit("户型佣金管理","house_type_manager2.html?communityid='+data[i].id +'","1","1000","700") class="label-success  radius label">查看</a>'+
                '</td>' +
                '</tr>';
        }
        $("tbody").html(tag);
